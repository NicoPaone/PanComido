...
- Create Angular project with ng: `ng new gestion-restaurante.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`gestion-restaurante.client.esproj`).
